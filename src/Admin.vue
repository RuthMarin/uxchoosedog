<template>
  ...
  <div class="col-sm-4" style="background-color:#FFae68;" v-for="it in adoptado"><br><img class= "img3" :src=it.foto >
    <div class="col-sm-6" style="background-color:#FFC592; text-align: center; -webkit-border-radius: 5px;
-moz-border-radius: 5px;
border-radius: 5px;" >{{it.nombre}} <br>
      <button type="button" class="btn btn-primary"  style="background-color:#EE7A17; " v-model="statementIsFalse" @click="postPost(it.id)">Adoptado</button><br>
  </div>
  <br>
</div>
  </div>
  <br>
    <div class="row"  >
      <div class="col-xs-6 col-md-4" style="background-color:#FC8945;margin-top: 20px; margin-bottom: 20px; align-items:center">
